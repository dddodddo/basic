//to preload images if needed
// like images you done or what
...
// get the images and dom elements
...
class Slideshow {
 ...
 //i used on load instead of on hover.
    window.onload = () => {
    ...
    // Listen for scroll events to navigate next or previous
    ...
    // Alternatively, i use the Observer plugin for more control
    this.scrollObserver = Observer.create({
      type: "wheel,touch,pointer",
      wheelSpeed: -1,
      onDown: () => this.navigate("next"),
      onUp: () => this.navigate("prev"),
      tolerance: 10,
      preventDefault: true
    });
