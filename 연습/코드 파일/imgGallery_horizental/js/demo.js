 ...
 */
{
    ...
    class Slide {
        constructor(el, title) {
            ...
            charming(this.DOM.title);  //글자 자르기위한 라이브러리 charming.js
            ...
            const render = () => {
                //if ( !this.isAnimating ) {
                    ...
                    for (let i = 0; i <= this.slidesTotal - 1; ++i) {
                        ...
                        //gsap.set(this.DOM.el, {rotation: mouseMoveVals.rotation});
                        //gsap.set(this.DOM.titlesWrap, {rotation: -2*mouseMoveVals.rotation});
                    }
                //}
